...
import 'package:paisa/src/data/debt/data_sources/debt_local_data_source_impl.dart'
    as _i15;
import 'package:paisa/src/data/debt/models/debt_model.dart' as _i11;
...
Future<_i1.GetIt> init(
  ...
  await gh.singletonAsync<_i5.Box<_i6.TransactionsModel>>(
    () => hiveBoxModule.transactionsBox,
    preResolve: true,
  );
  await gh.singletonAsync<_i5.Box<_i7.RecurringModel>>(
  ...
  await gh.singletonAsync<_i5.Box<_i8.ExpenseModel>>(
    () => hiveBoxModule.expenseBox,
    preResolve: true,
  );
  await gh.singletonAsync<_i5.Box<_i9.AccountModel>>(
    () => hiveBoxModule.accountBox,
    preResolve: true,
  );
  await gh.singletonAsync<_i5.Box<_i10.CategoryModel>>(
    () => hiveBoxModule.categoryBox,
    preResolve: true,
  );
  await gh.singletonAsync<_i5.Box<_i11.DebtModel>>(
  ...
  gh.singleton<_i14.DebtLocalDataSource>(_i15.DebtLocalDataSourceImpl(
    debtBox: gh<_i5.Box<_i11.DebtModel>>(),
    transactionsBox: gh<_i5.Box<_i6.TransactionsModel>>(),
  ));
  ...
  gh.singleton<_i27.LocalAccountDataManager>(_i28.LocalAccountDataManagerImpl(
      accountBox: gh<_i5.Box<_i9.AccountModel>>()));
  ...
  gh.factory<_i31.LocalExpenseDataManager>(
      () => _i32.LocalExpenseDataManagerImpl(gh<_i33.Box<_i8.ExpenseModel>>()));
  gh.factory<_i34.LocalRecurringDataManager>(() =>
      _i35.LocalRecurringDataManagerImpl(gh<_i5.Box<_i7.RecurringModel>>()));
