...
import 'package:paisa/src/data/debt/models/transactions_model.dart' as _i11;
...
import 'package:paisa/src/presentation/accounts/bloc/accounts_bloc.dart'
    as _i81;
import 'package:paisa/src/presentation/biometric/cubit/biometric_cubit.dart'
    as _i4;
...
Future<_i1.GetIt> init(
  ...
  await gh.singletonAsync<_i5.Box<_i6.RecurringModel>>(
    () => hiveBoxModule.recurringBox,
    preResolve: true,
  );
  await gh.singletonAsync<_i5.Box<_i7.ExpenseModel>>(
    () => hiveBoxModule.expenseBox,
    preResolve: true,
  );
  await gh.singletonAsync<_i5.Box<_i8.AccountModel>>(
    () => hiveBoxModule.accountBox,
    preResolve: true,
  );
  await gh.singletonAsync<_i5.Box<_i9.CategoryModel>>(
    () => hiveBoxModule.categoryBox,
    preResolve: true,
  );
  await gh.singletonAsync<_i5.Box<_i10.DebtModel>>(
    () => hiveBoxModule.debtsBox,
    preResolve: true,
  );
  await gh.singletonAsync<_i5.Box<_i11.TransactionsModel>>(
  ...
  gh.singleton<_i14.DebtLocalDataSource>(_i15.DebtLocalDataSourceImpl(
    debtBox: gh<_i5.Box<_i10.DebtModel>>(),
    transactionsBox: gh<_i5.Box<_i11.TransactionsModel>>(),
  ));
  ...
  gh.factory<_i26.HomeBloc>(
      () => _i26.HomeBloc(gh<_i5.Box<dynamic>>(instanceName: 'settings')));
  gh.singleton<_i27.LocalAccountDataManager>(_i28.LocalAccountDataManagerImpl(
      accountBox: gh<_i5.Box<_i8.AccountModel>>()));
  ...
  gh.factory<_i31.LocalExpenseDataManager>(
      () => _i32.LocalExpenseDataManagerImpl(gh<_i33.Box<_i7.ExpenseModel>>()));
  gh.factory<_i34.LocalRecurringDataManager>(() =>
      _i35.LocalRecurringDataManagerImpl(gh<_i5.Box<_i6.RecurringModel>>()));
  ...
  gh.singleton<_i57.GetAccountUseCase>(
      _i57.GetAccountUseCase(accountRepository: gh<_i41.AccountRepository>()));
  gh.singleton<_i58.GetAccountsUseCase>(
      _i58.GetAccountsUseCase(accountRepository: gh<_i41.AccountRepository>()));
