...
import 'package:paisa/src/di/module/hive_module.dart' as _i50;
...
import 'package:paisa/src/presentation/expense/bloc/expense_bloc.dart' as _i49;
...
_i1.GetIt init(
  ...
  gh.lazySingleton<_i11.DebtLocalDataSource>(() => _i12.DebtLocalDataSourceImpl(
  ...
  gh.singleton<_i23.LocalExpenseManagerDataSource>(
  ...
  gh.factory<_i39.GetExpensesUseCase>(() =>
      _i39.GetExpensesUseCase(expenseRepository: gh<_i33.ExpenseRepository>()));
  gh.factory<_i40.SummaryCubit>(
      () => _i40.SummaryCubit(gh<_i41.GetExpensesUseCase>()));
  gh.factory<_i42.AccountsBloc>(() => _i42.AccountsBloc(
        getAccountUseCase: gh<_i43.GetAccountUseCase>(),
        deleteAccountUseCase: gh<_i43.DeleteAccountUseCase>(),
        addAccountUseCase: gh<_i43.AddAccountUseCase>(),
        getAccountsUseCase: gh<_i43.GetAccountsUseCase>(),
      ));
  gh.factory<_i44.AddCategoryUseCase>(() => _i44.AddCategoryUseCase(
      categoryRepository: gh<_i29.CategoryRepository>()));
  gh.factory<_i45.AddExpenseUseCase>(() =>
      _i45.AddExpenseUseCase(expenseRepository: gh<_i33.ExpenseRepository>()));
  gh.factory<_i46.CategoryBloc>(() => _i46.CategoryBloc(
        getCategoryUseCase: gh<_i47.GetCategoryUseCase>(),
        addCategoryUseCase: gh<_i47.AddCategoryUseCase>(),
        deleteCategoryUseCase: gh<_i47.DeleteCategoryUseCase>(),
      ));
  gh.factory<_i48.DeleteExpenseUseCase>(() => _i48.DeleteExpenseUseCase(
      expenseRepository: gh<_i33.ExpenseRepository>()));
  gh.factory<_i49.ExpenseBloc>(() => _i49.ExpenseBloc(
...
class _$HiveModule extends _i50.HiveModule {}
